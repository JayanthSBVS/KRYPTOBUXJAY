export const QuickStart = () => {
  return (
    <div className="pb-10 md:scroll-m-[180px] scroll-m-28" id="start">
      ...
      <div className="p-6 rounded-md border mt-6 border-white/60 relative before:absolute before:w-full before:h-full before:bg-linear-to-br before:from-primary before:to-secondary before:blur-390 before:-right-32">
