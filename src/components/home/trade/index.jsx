    ...
    <section className="overflow-hidden">
      <div className="container relative">
        ...
        <div className="grid lg:grid-cols-2 gap-x-5 items-center relative z-10">
          <div>
            <img src={getImagePath("/images/trade/macbook.png")}
            alt="macBook-image"
            width={787}
            height={512} />
          ...
          <div className="flex flex-col gap-7">
            ...
            <div className="flex justify-between">
              <img src={getImagePath("/images/trade/mac.svg")}
              alt="macOS-image"
              width={61}
              height={105} />
              
              <div className="verticalLine"></div>
              <img src={getImagePath("/images/trade/appstore.svg")}
              alt="appstore-image"
              width={80}
              height={105} />
              
              <div className="verticalLine"></div>
              <img src={getImagePath("/images/trade/windows.svg")}
              alt="windows-image"
              width={80}
              height={105} />
              
              <div className="verticalLine"></div>
              <img src={getImagePath("/images/trade/android.svg")}
              alt="android-image"
              width={71}
              height={105} />
